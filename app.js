...
$("#SetPin").click(function(){
  ...
  {
    New = "yes";
    document.getElementById("display").innerHTML = "Enter your new pin and press Submit"
  }
  else
  {
    document.getElementById("display").innerHTML = "Enter your old pin to set new pin and press Submit"
  }
...
$("#CheckPin").click(function() {
  ...
  {
   New ="yes"
   document.getElementById("display").innerHTML = "No pin is saved, click on Set pin to Set new pin"
  }
  else
  {
   check = "yes";
   document.getElementById("display").innerHTML = "Enter pin and press Submit to check"
  }
...
$(".Submit-button").click(function() {
  ...
  if(New == "")
  {
     if(savedPin == oldPin){
      New ="yes";
      savedPin = ""
      document.getElementById("display").innerHTML = "Old pin correct, Enter new pin"
    }
    else
    {
      savedPin = "";
      document.getElementById("display").innerHTML = "Old pin incorrect, Enter old pin again"
    }
  }
else
{
  ...
  else
{
  ...
  savedPin = ""
  document.getElementById("display").innerHTML = "The pin is incorrect, Enter again"
}
